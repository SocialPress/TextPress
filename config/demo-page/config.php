...
return array(
	...
	'prefix' => '/demo-page',   // prefix to be added with all URLs. eg : '/blog'
	...
	'media.path'=> './config/demo-page/media',      // Path to images
	'article.path'=> './config/demo-page/articles',      // Path to articles
	'templates.path' => './templates',  // Path to common templates
	'google.analytics' => false, // Google analytics code. set false to disable
        // Globals - Site
        'body.background' => '/assets/backgrounds/royal-red.gif',        
        'header.background' => '/assets/backgrounds/transmit.gif',        
	'author.name' => 'J.R. Hull', // Global author name 
	'site.name'  => 'Demo Page',   // Site name "Brand"(Global)
