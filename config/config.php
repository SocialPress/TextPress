...
return array(
	...
	'media.path'=> './media',      // Path to images
	...
	'google.analytics' => false, // Google analytics code. set false to disable
        // Globals - Site
        'body.background' => '/assets/backgrounds/sand-blossom.gif',        
        'header.background' => '/assets/backgrounds/subtle-wood.gif',        
	'author.name' => 'J.R. Hull', // Global author name 
	'site.name'  => 'Social Press',   // Site name "Brand"(Global)
