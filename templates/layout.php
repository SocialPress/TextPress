      ...
      <div class="content">
          ...
          <div class="span12">
            <div class="subnav">
              <ul class="nav nav-pills">
                ...
                <li class="<?php echo ($this->data['path'] === 'location') ? 'active' : '' ?>"><a href="<?php echo $this->data['global']['prefix'];?>/location"><i class="icon-road"></i>Location</a></li>
        ...
        <div class="row">
          ...
          <div class="span4">
            ...
            <div class="well">
              <address>
                <strong><?php echo $this->data['global']['site.name'];?></strong><br>
                <?php echo $this->data['global']['location.address'];?><br>
                <?php echo $this->data['global']['location.locality'];?>, <?php echo $this->data['global']['location.region'];?> <?php echo $this->data['global']['location.postalcode'];?><br>
                <abbr title="Phone">P:</abbr><?php echo $this->data['global']['location.phonenumber'];?>
              </address>
            </div>
